...
namespace Spreadsheet_Keila_Holcombe
{
    ...
    public partial class Form1 : Form
    {
        ...
        /// <summary>
        /// Updates the undo and redo button on the spreadsheet.
        /// </summary>
...
#pragma warning restore CS8601 // Possible null reference assignment.
        ...
        /// <summary>
        /// Loads the chosen xml file and apply to the current spreadsheet.
        /// Referenced the following on how to do the load:
        /// https://learn.microsoft.com/en-us/dotnet/api/system.windows.forms.openfiledialog?view=windowsdesktop-10.0.
        /// </summary>
        /// <param name="sender"> Object of the button.</param>
        /// <param name="e"> Event data of the button.</param>
        private void LoadFileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    this.spreadsheet.LoadFile(file);
                }
            }
        ...
        /// <summary>
        /// When the user clicks the save button, it saves the spreadsheet as a xml file.
        /// Referenced the following:
        /// https://learn.microsoft.com/en-us/dotnet/desktop/winforms/controls/how-to-save-files-using-the-savefiledialog-component.
        /// </summary>
        /// <param name="sender"> Object of the button.</param>
        /// <param name="e"> Event data of the button. </param>
        private void SaveFileToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (saveFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    this.spreadsheet.SaveFile(file);
                }
            }
        }
    }
