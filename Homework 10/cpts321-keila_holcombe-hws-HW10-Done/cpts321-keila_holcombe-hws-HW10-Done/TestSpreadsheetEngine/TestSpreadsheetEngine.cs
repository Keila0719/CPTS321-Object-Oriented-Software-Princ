...
namespace TestSpreadsheetEngine
{
    ...
    public class TestSpreadsheetEngine
    {
        ...
        public void TestEvaluateCellStringValue()
        {
            ...
            // Check if it was able to return the correct error type
            Assert.That(cell1.Value, Is.EqualTo("2"));
        }
...
#pragma warning restore CS8604 // Possible null reference argument.
        ...
        /// <summary>
        /// Testing edge case of evaluate where it checks for Self Reference.
        /// </summary>
        [Test]
        public void TestSelfReference()
        {
            ...
            Assert.That(cell1?.Value, Is.EqualTo("#Self Reference!"));
        }
        ...
        /// </summary>
        [Test]
        public void TestSelfReferenceExpression()
        {
            Spreadsheet spreadsheet = new Spreadsheet(50, 26);
            Cell? cell1 = spreadsheet.GetCell(0, 0);
            cell1!.Text = "=101+(322*B2/A1)";

            Assert.That(cell1?.Value, Is.EqualTo("#Self Reference!"));
        }

        /// <summary>
        /// Testing edge case to check if the current cell won't change if referencing cell is self referencing.
        /// </summary>
        [Test]
        public void TestSelfReferenceDontChange()
        {
            Spreadsheet spreadsheet = new Spreadsheet(50, 26);
            Cell? cell1 = spreadsheet.GetCell(0, 0);
