...
namespace TestSpreadsheetEngine
{
    ...
    internal class TestExpressionTree
    {
        ...
        /// <summary>
        /// Testing a normal case for evaluate() to see if it's able to subtract numbers and variables together.
        /// </summary>
        [Test]
        public void TestEvaluateSubtraction()
        {
            string expression = "10-A1-8";
            ExpressionTree expressionTree = new ExpressionTree(expression);
        ...
        /// <summary>
        /// Testing a normal case for evaluate() tp see of it's able to multiply numbers and variables together.
        /// </summary>
        [Test]
        public void TestEvaluateMultiplication()
        {
            ...
            ExpressionTree expressionTree = new ExpressionTree(expression);
            expressionTree.SetVariable("A1", 1.5);
            double? testValue = expressionTree.Evaluate();

            if (testValue != null)
            {
                Assert.That(Math.Round((double)testValue, 4), Is.EqualTo(22.5));
            }
        }
        ...
        public void TestEvaluateDivision()
        {
            ...
            if (testValue != null)
            {
                Assert.That(Math.Round((double)testValue, 4), Is.EqualTo(0.75));
            }
        }
